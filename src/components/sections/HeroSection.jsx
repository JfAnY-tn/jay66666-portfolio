...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Scroll hint */}
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-10 animate-[fadeIn_0.8s_ease-out_1s_both]">
        <span className="block text-xs tracking-widest text-gray-500 dark:text-cinema-text-muted text-center">
          向下滚动
        </span>
        <svg
